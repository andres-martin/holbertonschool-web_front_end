...
-   [Bootstrap](https://intranet.hbtn.io/rltoken/KONUufQGw1qbnF3Qc-OpCg "Bootstrap")

Learning Objectives
-------------------

At the end of this project, you are expected to be able to [explain to anyone](https://intranet.hbtn.io/rltoken/A8ZrLvH7HLAQ8BMFzlskjw "explain to anyone"), **without the help of Google**:
